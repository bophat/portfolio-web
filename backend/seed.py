...
def seed_data(db: Session):
    ...
    # Seed Learning Goals
    if db.query(models.LearningGoal).count() == 0:
        learning_goals_data = [
            {
                "category": "currently",
                "icon": "🎯",
    ...
    # Seed About Info
    if not db.query(models.AboutInfo).first():
    ...
    # Seed Quick Facts
    if db.query(models.QuickFact).count() == 0:
        quick_facts_data = [
    ...
    db.commit()
    # Seed Timeline Items
    if db.query(models.TimelineItem).count() == 0:
        timeline_items = [
            models.TimelineItem(
                period="2024 - Present",
                title="Senior Full Stack Engineer",
                organization="Tech Innovators Inc.",
                description="Leading the development of scalable web applications using React, Python, and AWS. Mentoring junior developers and implementing CI/CD pipelines.",
                item_type="work",
                icon="briefcase",
                sort_order=30
            ),
            models.TimelineItem(
                ...
                description="Built responsive websites and integrated payment gateways. Collaborated with design teams to deliver pixel-perfect UIs.",
                item_type="work",
                icon="code",
                sort_order=20
            ),
            models.TimelineItem(
                ...
                description="Graduated with Honors. Specialized in Artificial Intelligence and Database Systems. Capstone project focused on machine learning for image recognition.",
                item_type="education",
                icon="graduation-cap",
                sort_order=10
            )
